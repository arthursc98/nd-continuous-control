...
UPDATE_TIMESTEPS = 20   # Update Critic at every X timesteps
UPDATE_NETWORK = 10     # Update Network X times
...
class Agent():
    ...
    def step(self, state, action, reward, next_state, done, timestep):
        ...
        if (len(self.memory) > BATCH_SIZE) and (timestep % UPDATE_TIMESTEPS == 0):
            for t in range(UPDATE_NETWORK):
