...
class BaseModel(object):
    ...
    # region [Actor and Critic]
class Actor(nn.Module, BaseModel):
    """Actor (Policy) Model."""

    def __init__(self, state_size, action_size, seed, fc_units=512, fc2_units=256):
...
class Critic(nn.Module, BaseModel):
    """Critic (Value) Model."""
